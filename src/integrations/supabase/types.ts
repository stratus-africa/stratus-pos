...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      digitax_connection_status: "unconfigured" | "connected" | "disconnected" | "error";
      digitax_environment: "sandbox" | "production";
      digitax_invoice_type: "invoice" | "credit_note" | "debit_note" | "proforma";
      digitax_queue_status:
        ...
        | "validation_failed"
        | "skipped";
      fiscal_status: "not_applicable" | "pending_submission" | "submitted" | "accepted" | "failed" | "retry_required";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
