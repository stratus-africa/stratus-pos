-- Self-signup onboarding: persist the seven-step wizard before a tenant exists,
-- then atomically create the business, first location, owner role and permissions.
...
DROP TRIGGER IF EXISTS update_onboarding_drafts_updated_at ON public.onboarding_drafts;
